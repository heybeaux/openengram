...
| apps/code-api                 | `heybeaux/engram-code`                 |        `main` | `6d5b72317cea` | subtree     |       PR #9 | Code-intel NestJS app. Imported in PR #9; isolated CI added in PR #12; root workspace membership in progress. |
