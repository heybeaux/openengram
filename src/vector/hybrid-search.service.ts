...
export class HybridSearchService {
  ...
  async textSearch(
    ...
    // Validate limit is a safe positive integer before interpolation.
    // LIMIT cannot be parameterized in $queryRawUnsafe with positional params;
    // we use Math.trunc to guarantee it's an integer (no injection possible).
