...
export class GraphRecallService {
  ...
  private static readonly STOP_WORDS = new Set([
    ...
    'am', 'if', 'then', 'than', 'so', 'no', 'not', 'only', 'very',
    'just', 'don', 'now', 'how', 'all', 'each', 'every', 'both',
    'few', 'more', 'most', 'some', 'any', 'such', 'into', 'with',
    'about', 'between', 'through', 'during', 'before', 'after',
    'above', 'below', 'to', 'from', 'up', 'down', 'in', 'out',
    'on', 'off', 'over', 'under', 'again', 'further', 'once',
    'here', 'there', 'when', 'where', 'why', 'how', 'of', 'at',
    'by', 'for', 'tell', 'know', 'think', 'like', 'get', 'make',
    'go', 'see', 'come', 'take', 'want', 'look', 'use', 'find',
    'give', 'say', 'said', 'also', 'well', 'back', 'much',
    'does', 'doing', 'done',
  ]);
  ...
  async recallViaGraph(
    ...
    try {
      ...
      this.logger.warn(
        `[GraphRecall] Failed: ${(error as Error).message}`,
      );
      return [];
    }
  }
